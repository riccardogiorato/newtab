...
const Privacy: NextPage = () => {
  return (
    <main className="p-6 max-w-2xl mx-auto">
      ...
      <h2>Introduction</h2>
      <p>
        Welcome to <strong>NewTab</strong>
      </p>
      <p>
        If you signed up directly with NewTab this Privacy Policy governs your
        visit to the Service, and explains how we collect, safeguard and
      ...
      <p>
        ...
        <a href="https://newtab.riccardogiorato.com/">
          newtab.riccardogiorato.com
        </a>
        website.
      </p>
      <p>
      ...
      <h2>Google Auth</h2>
      <p>
        If you log in with your Google account, NewTab will obtain information
        from the Google account. The service reminds you that it is up to you to
        check what your privacy settings on your Google account allow you to
        share.
      </p>

      <h2>Use of Data</h2>
      <p>NewTab uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        NewTab will take all the steps reasonably necessary to ensure that your
