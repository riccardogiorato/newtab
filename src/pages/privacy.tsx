    ...
    <>
      <main className="p-6 max-w-2xl mx-auto">
        ...
        <p>
          ...
          from the Google account. The service reminds you that it is up to you
          to check what your privacy settings on your Google account allow you
          to share.
        </p>
        ...
        <p>
          NewTab will take all the steps reasonably necessary to ensure that
